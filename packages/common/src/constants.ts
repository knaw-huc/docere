...
|           |                          |    |   48        |    |
+-----------|--------------------------+----+-------------+----+*/
export const TEXT_PANEL_GUTTER_WIDTH = DEFAULT_SPACING * 3 /* 96 */
...
export const TEXT_PANEL_WIDTH = TEXT_PANEL_GUTTER_WIDTH + TEXT_PANEL_TEXT_WIDTH + TEXT_PANEL_MINIMAP_WIDTH + (3 * DEFAULT_SPACING)
