...
const projectList: ProjectList = projectIds.reduce((prev, curr) => {
	prev[curr] = {
		config: async function() { return await import(`./${curr}/config`) },
		getTextComponents: async function() { return await import(`./${curr}/text-components`) },
		getUIComponents: async function() { return await import(`./${curr}/ui-components`) },
	}
	return prev
}, {} as ProjectList)
