...
const thumbByProjectId: Record<string, string> = {
	...
	utrechtpsalter: 'http://objects.library.uu.nl/fcgi-bin/iipsrv.fcgi?IIIF=/manifestation/viewer/89/31/57/89315756556586257582682156457459945203.jp2/square/200,200/0/default.jpg',
